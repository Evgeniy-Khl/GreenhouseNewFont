...
Date    : 07.10.2022
Clock   : 16 MHz
Program size: 15648 words (31296 bytes), 95,5% of FLASH  05.11.2022
*******************************************************/
...
eeprom unsigned char module[4][4]={
                      {  0,100,100,100}, // Грунт влажность 0%: 100% OutMIN; OutMAX; модуль №1
                      {  0,100,101,100}, // Грунт влажность 0%: 100% OutMIN; OutMAX; модуль №2
                      {  0,100,102,100}, // Грунт влажность 0%: 100% OutMIN; OutMAX; модуль №3
                      {  0,100,103,100}};// Грунт влажность 0%: 100% OutMIN; OutMAX; модуль №4
bit Night;
bit Sec;
bit Dht;
bit Clock_Ok;
